...
var ApiController = function(app) {
    ...
    */
    ...
    // Add one Result to the resultDatastore, has to contain a runId
    app.post('/api/save-run', function(req, res) {
        resultsDatastore.deleteResult(req.body.runId).then(function(){
            resultsDatastore.saveResult(req.body)
            .then(function() {
                res.send(req.body.runId);
            });
        });
    });
